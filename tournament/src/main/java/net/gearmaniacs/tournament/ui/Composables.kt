...
@Composable
fun ColorMarkChip(colorMark: ColorMark, value: Boolean, onClick: () -> Unit) {
    FilterChip(
        selected = value,
        onClick = onClick,
        label = { Text(stringResource(colorMark.getLabelResource())) },
        colors = FilterChipDefaults.filterChipColors(
            selectedLabelColor = Color.White,
            selectedContainerColor = colorResource(colorMark.getColorResource())
        )
    )
}
