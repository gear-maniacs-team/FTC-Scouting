...
internal object SpreadsheetFields {
    ...
    val TEAM_COLUMNS = listOf(
        "Number", "Name", "Depot Minerals", "Lander Minerals", "Endgame", "Preferred Location", "Comments",
        "Auto - Latching", "Auto - Sampling", "Auto - Marker", "Auto - Parking", "Auto - Minerals"
    )

    val MATCHES_COLUMNS = listOf("Number", "Red 1", "Red 2", "Red Score", "Blue 1", "Blue 2", "Blue Score")
